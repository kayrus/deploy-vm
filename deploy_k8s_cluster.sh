...
MASTER_USER_DATA_TEMPLATE=$LIBVIRT_PATH/user_data
NODE_USER_DATA_TEMPLATE=$LIBVIRT_PATH/user_data
...
for SEQ in $(seq 1 $1); do
        ...
        sed "s#%DISCOVERY%#$ETCD_DISCOVERY#g;s#%HOSTNAME%#$COREOS_HOSTNAME#g;s#%MASTER_HOST%#$COREOS_MASTER_HOSTNAME#g;s#%K8S_RELEASE%#$K8S_RELEASE#g;s#%FLANNEL_TYPE%#$FLANNEL_TYPE#g;s#%K8S_NET%#$K8S_NET#g;s#%K8S_DNS%#$K8S_DNS#g;s#%K8S_DOMAIN%#$K8S_DOMAIN#g" $USER_DATA_TEMPLATE > $LIBVIRT_PATH/$COREOS_HOSTNAME/openstack/latest/user_data
